...
function reload(data) {
    ...
    for (let item of data) {
        ...
        text_one.innerHTML = item.title.length > 5 ? item.title.slice(0, 5) : item.title

        text_two.innerHTML = item.description.length > 45 ? item.description.slice(0, 45) : item.description
